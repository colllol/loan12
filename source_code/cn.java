...
public class cn extends GameCanvas implements Runnable {
  private int a = 0;
  ...
  private void d() {
    ...
    if (this.q == 0) {
      ...
      this.b.drawString("www.giaitri321.pro", this.e / 2, this.d - 5, 65);
  ...
  private void e() {
    ...
    int i = this.l - this.j / 2 - this.g * this.j;
    this.b.fillRect(0, i, this.e, this.j / 2 - this.k);
    i = i + 10 - this.j / 2 - this.k;
    this.b.fillRect(0, i, this.e, this.j / 2 - this.k);
    i = this.l - this.j / 2 + this.g * this.j;
    this.b.fillRect(0, i, this.e, this.j / 2 - this.k);
    i = i + 10 - this.j / 2 - this.k;
    this.b.fillRect(0, i, this.e, this.j / 2 - this.k);
    this.k += this.m;
...
/* Location:              C:\Users\bot-nosense\Downloads\Loan-12-Su-Quan.jar!\cn.class
