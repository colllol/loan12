public class dg {
  public static final int a = a(90);
  
  public static final int b = a(180);
  
  public static final int c = a(270);
  
  public static final int d = a(360);
  
  private static final short[] e = new short[] { 
      0, 16, 22, 27, 32, 35, 39, 42, 45, 48, 
      50, 53, 55, 57, 59, 61, 64, 65, 67, 69, 
      71, 73, 75, 76, 78, 80, 81, 83, 84, 86, 
      87, 89, 90, 91, 93, 94, 96, 97, 98, 99, 
      101, 102, 103, 104, 106, 107, 108, 109, 110, 112, 
      113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 
      123, 124, 125, 126, 128, 128, 129, 130, 131, 132, 
      133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 
      143, 144, 144, 145, 146, 147, 148, 149, 150, 150, 
      151, 152, 153, 154, 155, 155, 156, 157, 158, 159, 
      160, 160, 161, 162, 163, 163, 164, 165, 166, 167, 
  ...
  private static final int[] f = new int[] { 498, 10882 };
  
  private static final int[] g = new int[] { -1228, 4866, 13901, 102939 };
  ...
  public static int a(int paramInt1, int paramInt2) {
    return (int)(paramInt1 * paramInt2 >> 16L);
  }
  
  public static int b(int paramInt1, int paramInt2) {
    return (paramInt2 > Math.abs(4)) ? (int)((paramInt1 << 16L) / paramInt2) : 0;
  }
  
  public static int c(int paramInt) {
    int i = paramInt + 65536 >> 1;
    byte b = 8;
    while (--b >= 0)
      i = i + b(paramInt, i) >> 1; 
    return i;
...
/* Location:              C:\Users\bot-nosense\Downloads\Loan-12-Su-Quan.jar!\dg.class
